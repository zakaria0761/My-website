  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-col md:flex-row border-b">
        ...
        <div className="w-full md:w-1/2 p-6">
          <h2 className="text-xl font-bold mb-2">
            The lesson plan I felt was successful :
          </h2>

          <p className="leading-relaxed">Teacher : Zakaria Aherach</p>
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-50">
          <img
            ...
            alt="Lesson Plan 1"
            className="w-full max-h-100 md:h-full object-contain cursor-zoom-in"
            onClick={() =>
              setSelectedImage("/document/most lesson plan.png")
            }
          />
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row border-b">
        ...
        <div className="w-full md:w-1/2 p-6">
          <h2 className="text-xl font-bold mb-2">
            The lesson plan that I felt could be improved :
          </h2>
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-50">
          <img
            ...
            className="w-full max-h-100 md:h-full object-contain cursor-zoom-in"
            onClick={() =>
              setSelectedImage("/document/least lesson plan.jpg")
            }
          />
        </div>
      </div>
